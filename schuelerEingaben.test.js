...
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Raupe', 'BauBe')).toBe('3/4')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Rei-ter', 'Rater')).toBe('4/5')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Dö-ner', 'Duma')).toBe('1/5')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Mö-wen-fe-der', 'Mädenfeler')).toBe('7/10')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Scheu-nen-tor', 'Schäunnentor')).toBe('6/8')})

test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'An-teil', 'Antal')).toBe('4/5')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Fa-den', 'Waten')).toBe('3/5')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Ha-fen', 'Hwen')).toBe('3/5')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Ha-fen', 'Hwen')).toBe('3/5')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Pe-da-len', 'BeTalen')).toBe('5/7')})
test('Tapete --> Dabede', () => {expect(markErrors('pupilsWriting 3', 'pupilSheet1', null, null, 'Ku-si-ne', 'KQsine')).toBe('5/7')})
