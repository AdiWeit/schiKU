...
function printMode(checked, pressed) {
  if (checked) {
    if (!pressed) alert("drücken sie Str und p, um die Website ausdrucken zu können. Die Optionen (drucken, als PDF speichern, Grafikeinstellungen etc.) erscheinen einige Zeit nach dem Druckauftrag, oder durch Neuladen der Seite wieder. Bevor sie die Tastenkombination drücken, warten sie jedoch bitte ab, bis die Optionen verschwunden sind.");
    else {
